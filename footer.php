            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget widget widget_nav_menu">
                        ...
                        <ul>
                            <li><a href="services.php">Warhouse</a></li>
                            <li><a href="services.php">Air Fright Soultions for all</a></li>
                            <li><a href="services.php">Sea Fright solutions & Catering</a></li>
                    ...
                    <div class="footer-widget widget ">
                        ...
                        <ul class="contact_info_list">
                            <li class="single-info-item">
                                <div class="details">
                                    1905 S Azusa Ave, Hacienda Heights, CA 91745, USA
                                </div>
                            </li>
                            <li class="single-info-item">
                                <div class="details">
