				...
				<div class="col-md-6 col-md-offset-3">
					...
					<form  class="fh5co-form animate-box" data-animate-effect="fadeIn" name="form1" id="userForm" method="post" novalidate>
						...
						if(isset($_POST['user'])&& md5($_POST['password'])) {
							$error = verify_users($_POST['user'],md5(PASS_SALT.$_POST['password']),$_POST['estado']);	 								
						} else {
								echo '
									<div class="form-group">
										<label for="username" class="sr-only">Username</label>
										<input type="text" class="form-control" id="user-name" name="user" placeholder="Your Username" tabindex="1" required data-validation-required-message= "Please enter your username." autofocus autocomplete="off">
									</div>
									<div class="form-group">
